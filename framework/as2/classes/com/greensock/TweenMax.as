 ...
 * 											com.greensock.easing.Elastic.easeOut. The Default is Regular.easeOut.</li>
 * 	
 ...
 * 										</ul></li>
 * 	
 * 	<li><b> repeat : Number</b>					Number of times that the tween should repeat. To repeat indefinitely, use -1.</li>
 * 	
 ...
 * 												tween it from 0 to 500, do <code>TweenMax.to(mc, 2, {_x:500, startAt:{_x:0}});</code> </li>
 * </ul>
 * 
 * <b>PLUGINS: </b><br /><br />
 * 
 ...
 * 						   
 * 	  <li><b> visible : Boolean</b> - To set a MovieClip's "_visible" property at the end of the tween, use this special property.</li>
 * 	  
 * 	  <li><b> volume : Number</b> - Tweens the volume of a MovieClip or Sound</li>
 * 	  
 * 	  <li><b> tint : Number</b> - To change a MovieClip's tint/color, set this to the hex value of the tint you'd like
 * 					  			  to end up at(or begin at if you're using TweenMax.from()). An example hex value would be 0xFF0000.</li>
 * 					  
 * 	  <li><b> removeTint : Boolean</b> - If you'd like to remove the tint that's applied to a MovieClip, pass true for this special property.</li>
 * 	  
 ...
 * 					   			  <code>TweenMax.to(my_mc, 3, {_x:500, _y:0, bezier:[{_x:250, _y:50}]});</code></li>
 * 					   
 ...
 * 							in a boolean value of true and TweenMax will use a typical setup, <code>[["_x", "_y", "_rotation", 0]]</code>. 
 ...
 * 	  						   instead of "_rotation" as the property. For example, if <code>myObject._rotation</code> is currently 170 degrees 
 ...
 * 	  					   every time the tween is rendered, you'd do: <code>TweenMax.to(mc, 2, {_x:300, _y:200, _alpha:50, roundProps:["_x","_y"]});</code></li>
 * 	  					   
 ...
 * 
 * 		TweenMax.to(mc, 5, {_alpha:50, _x:120, ease:Back.easeOut, delay:2, onComplete:onFinishTween, onCompleteParams:[5, mc]});<br /> 
 ...
 * 
 * 		TweenMax.from(mc, 5, {_y:"-100", ease:Elastic.easeOut});</code><br /><br />
 * 
 * 
 * <b>NOTES / TIPS:</b>
 * <ul>
 * 	<li> Passing values as Strings will make the tween relative to the current value. For example, if you do
 * 	  <code>TweenMax.to(mc, 2, {_x:"-20"});</code> it'll move the mc._x to the left 20 pixels which is the same as doing
 * 	  <code>TweenMax.to(mc, 2, {_x:mc._x - 20});</code> You could also cast it like: <code>TweenMax.to(mc, 2, {_x:String(myVariable)});</code></li>
 * 	  
...
class com.greensock.TweenMax extends TweenLite {
		/** @private **/
		public static var version:Number = 11.66;
